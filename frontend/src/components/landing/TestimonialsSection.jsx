...
const testimonials = [
  {
    ...
    avatar: 'SM',
    avatarGrad: 'from-[#1B98E0] to-[#C2FFF0]',
    stars: 5,
  ...
  },
  {
    ...
    avatar: 'AR',
    avatarGrad: 'from-[#0E7C7B] to-[#C2FFF0]',
    stars: 5,
  ...
  },
  {
    ...
    avatar: 'ML',
    avatarGrad: 'from-[#0E7C7B] to-[#1B98E0]',
    stars: 5,
  ...
  },
  {
    ...
    avatar: 'FA',
    avatarGrad: 'from-[#1B98E0] to-[#0E7C7B]',
    stars: 5,
...
const TestimonialsSection = () => {
  ...
  return (
    <section id="testimonials" ref={ref} className="py-28 bg-[#E8E8E8] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black text-[#0D1B2A] mb-4 leading-tight">
        ...
        >
          {testimonials.map((t) => (
            <motion.div
              ...
              className="bg-white border border-[#0E7C7B]/10 rounded-3xl p-8 flex flex-col gap-5 relative transition-shadow"
            >
              <Quote size={28} className="text-[#0E7C7B]/15 absolute top-6 right-6" />
              ...
              <p className="text-[#0D1B2A] text-[15px] leading-relaxed">"{t.text}"</p>

              <div className="flex items-center gap-3 mt-auto pt-4 border-t border-[#0E7C7B]/10">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-[#3D5A80] text-xs">{t.role}</p>
                </div>
                <span className="shrink-0 text-[10px] font-semibold bg-[#C2FFF0]/40 text-[#0E7C7B] border border-[#0E7C7B]/15 px-2.5 py-1 rounded-full">
                  {t.tag}
                </span>
              </div>
            </motion.div>
        ...
        <div className="md:hidden relative">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-white border border-[#0E7C7B]/10 rounded-3xl p-7 flex flex-col gap-5"
            >
              <div className="flex gap-1">
              ...
              <p className="text-[#0D1B2A] text-[15px] leading-relaxed">"{testimonials[active].text}"</p>
              <div className="flex items-center gap-3 pt-4 border-t border-[#0E7C7B]/10">
                ...
                <div>
                  <p className="text-[#0D1B2A] font-bold text-sm">{testimonials[active].name}</p>
                  <p className="text-[#3D5A80] text-xs">{testimonials[active].role}</p>
                </div>
              </div>
            </motion.div>
          </AnimatePresence>
          ...
          <div className="flex justify-center gap-3 mt-6">
            <button onClick={prev} className="w-10 h-10 rounded-full border border-[#0E7C7B]/15 bg-white flex items-center justify-center hover:bg-[#C2FFF0]/30 transition">
              <ChevronLeft size={18} />
            </button>
            <div className="flex items-center gap-2">
              {testimonials.map((_, i) => (
                <button key={i} onClick={() => setActive(i)}
                  className={`w-2 h-2 rounded-full transition-all ${i === active ? 'bg-[#0E7C7B] w-5' : 'bg-[#0E7C7B]/20'}`}
                />
              ))}
            </div>
            <button onClick={next} className="w-10 h-10 rounded-full border border-[#0E7C7B]/15 bg-white flex items-center justify-center hover:bg-[#C2FFF0]/30 transition">
